...
// Axiolid is f64 throughout -- Point3, Tolerance, and every kernel
// measure are double precision -- so upstream's `f32` feature had no
// reachable configuration here. The f32 branch is dropped rather than
// left as an unbuildable cfg (ADR 0047).
mod precision {
